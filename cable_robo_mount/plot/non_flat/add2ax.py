...
def add2ax_mirror_tripods(ax, nodes, mirror_tripods):
    for mirror_tripod in mirror_tripods:
        ...
        ax.plot(
            [n1[0], n2[0]], [n1[1], n2[1]], [n1[2], n2[2]], "r", linewidth=3.0
        )
        ax.plot(
            [n2[0], n3[0]], [n2[1], n3[1]], [n2[2], n3[2]], "r", linewidth=3.0
        )
        ax.plot(
            [n3[0], n1[0]], [n3[1], n1[1]], [n3[2], n1[2]], "r", linewidth=3.0
        )
...
def add2ax_fixtures(ax, nodes, fixtures):
    for fixture in fixtures:
        ...
        ax.scatter([fix_pos[0]], [fix_pos[1]], [fix_pos[2]], c="g", marker="o")
