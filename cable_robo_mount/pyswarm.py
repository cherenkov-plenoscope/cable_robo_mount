...
def pso(
    ...
    while it <= maxiter:
        ...
        if fp[i_min] < fg:
            if debug:
                print(
                    "New best for swarm at iteration {:}: {:} {:}".format(
                        it, p[i_min, :], fp[i_min]
                    )
                )
            ...
            if np.abs(fg - fp[i_min]) <= minfunc:
                print(
                    "Stopping search: Swarm best objective change less than {:}".format(
                        minfunc
                    )
                )
                if particle_output:
                ...
                print(
                    "Stopping search: Swarm best position change less than {:}".format(
                        minstep
                    )
                )
                if particle_output:
