...
def test_HomTra_all():
    ...
    assert np.isclose(
        t.transformed_position_inverse(A),
        t.inverse().transformed_position(A),
        1e-9,
    ).all()
    assert np.isclose(
        t.transformed_position_inverse(B),
        t.inverse().transformed_position(B),
        1e-9,
    ).all()
    assert np.isclose(
        t.transformed_position_inverse(C),
        t.inverse().transformed_position(C),
        1e-9,
    ).all()
