...
def get_nodes_zenith_position(nodes_rotated, cable_supports, homogenous_transformation):
    ...
    for i in range(nodes_rotated.shape[0] - cable_supports.shape[0], nodes_rotated.shape[0]):
