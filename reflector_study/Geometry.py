...
class Geometry(object):
    def __init__(self, cfg):
        ...
        self.facet_inner_hex_radius = cfg['reflector']['facet']['inner_hex_radius']
        self.davies_cotton_over_parabola_ratio = cfg['reflector']['optics']['davies_cotton_over_parabola_ratio']
        self.reflector_security_distance_from_ground = cfg["reflector"]["main"]["security_distance_from_ground"]
        ...
        self.tension_ring_support_position = cfg['tension_ring']['support_position']

        self.tait_bryan_angle_Rx = np.deg2rad(cfg["structure_spatial_position"]["rotational_vector_Rx_Ry_Rz"][0])
        self.tait_bryan_angle_Ry = np.deg2rad(cfg["structure_spatial_position"]["rotational_vector_Rx_Ry_Rz"][1])
        self.tait_bryan_angle_Rz = np.deg2rad(cfg["structure_spatial_position"]["rotational_vector_Rx_Ry_Rz"][2])
    ...
    def _set_up_transformations(self, cfg):
        ...
        self.dish2camera.set_translation(
            np.array([0,0,cfg['camera']['sensor_distance_to_principal_aperture_plane']])+
